                        ...
                        @else
                                  ...
                                  <li class="nav-item" style="background-color:#E4E9F2; margin-bottom:5px;">
                                    ...
                                    <div class="row">
                                      <div class="col-md-2 pull-right">
                                        <img src="{{url('/')}}/public/img/{{$note->picture}}" style="width:50px; height:50px; margin-left:5px; border-radius:5px;">
                                      </div>
                                      <div class="col-md-10">
                            ...
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                      <img src="{{url('/')}}/public/img/{{Auth::user()->picture}}" width="40px" height="40px" alt="" class="rounded-circle"> {{ Auth::user()->name }} <span class="caret"></span>
                                </a>
